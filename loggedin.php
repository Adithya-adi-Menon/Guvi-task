...
<div class="group">
        ...
        <div class="col-2">
            <input type="text" id="f-name" name="username" placeholder="Username" value="<?php echo $row["username"]?>" disabled />
        </div>
    </div>
    <div class="group">
    <div class="col-1">
    ...
    <div class="col-2">
        <input type="text" id="l-name" name="email" placeholder="Email" value="<?php echo $row["email"]?>" disabled />
    </div>
</div>
<!-- Password -->
<div class="group">
